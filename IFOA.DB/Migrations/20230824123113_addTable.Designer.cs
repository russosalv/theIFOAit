...
namespace IFOA.DB.Migrations
{
    ...
    [Migration("20230824123113_addTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IFOA.DB.Entities.CandidateExperience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CandidateExperience", "ifoa");
                });
            ...
            modelBuilder.Entity("IFOA.DB.Entities.CandidateSpokenLanguage", b =>
                {
                    ...
                    b.Property<int>("ListeningCefrLevel")
                        .HasColumnType("int");

                    b.Property<int>("ReadingCefrLevel")
                        .HasColumnType("int");

                    b.Property<int>("SpeakingCefrLevel")
                        .HasColumnType("int");

                    b.Property<int>("WritingCefrLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IFOA.DB.Entities.CandidatePreferredJobFunction", b =>
                {
                    b.HasOne("IFOA.DB.Entities.Candidate", "Candidate")
                        .WithMany("CandidatePreferredJobFunctions")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IFOA.DB.Entities.CandidatePreferredLocation", b =>
                {
                    b.HasOne("IFOA.DB.Entities.Candidate", "Candidate")
                        .WithMany("CandidatePreferredLocations")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IFOA.DB.Entities.CandidateSpokenLanguage", b =>
                {
                    b.HasOne("IFOA.DB.Entities.Candidate", "Candidate")
                        .WithMany("CandidateSpokenLanguages")
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IFOA.DB.Entities.Candidate", b =>
                {
                    ...
                    b.Navigation("CandidatePreferredJobFunctions");

                    b.Navigation("CandidatePreferredLocations");

                    b.Navigation("CandidateProjects");

                    b.Navigation("CandidateSpokenLanguages");
                });
